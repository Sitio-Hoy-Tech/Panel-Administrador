  ...
  if (!orders || orders.length === 0) {
    return (
      <div className="p-16 text-center flex flex-col items-center justify-center relative overflow-hidden">
        <div className="h-20 w-20 bg-surface border border-white/[0.05] rounded-2xl flex items-center justify-center mb-6">
    ...
    <>
      ...
      <div className="hidden md:block">
        <table className="w-full text-left">
          <thead>
            <tr className="text-slate-500 text-[11px] uppercase tracking-[0.15em] font-bold border-b border-white/[0.05]">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="text-xs font-black text-slate-500 uppercase tracking-widest">Orden</span>
        ...
        <div className="text-right">
          ...
          <div className="flex items-center justify-end gap-1.5 mt-1">
            <CreditCard className={`h-3 w-3 ${order.mp_payment_id ? 'text-emerald-400' : 'text-slate-500'}`} />
            <span className={`text-[10px] font-bold uppercase tracking-wider ${order.mp_payment_id ? 'text-emerald-400' : 'text-slate-500'}`}>
