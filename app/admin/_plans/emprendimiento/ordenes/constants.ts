...
export const statusMap: any = {
  confirmed: { label: "Pagado", color: "text-blue-400", bg: "bg-blue-400/10", icon: CheckCircle2 },
  ...
  pending: { label: "Pendiente Pago", color: "text-zinc-500", bg: "bg-zinc-500/10", icon: Clock },
};
