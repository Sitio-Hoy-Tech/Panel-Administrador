      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(180px,auto)]">
        ...
        <div className="md:col-span-1 glass-panel p-8 flex flex-col justify-between relative group overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between mb-4">
            <h3 className="text-slate-400 font-medium tracking-wide text-sm uppercase">Plan Empresa</h3>
          ...
          <div className="relative z-10 flex items-center gap-6 mt-4">
            <div className="relative h-24 w-24 flex items-center justify-center">
              <div className="absolute inset-0 rounded-full border-2 border-white/[0.05] shadow-inner"></div>
              <div className="absolute inset-2 rounded-full border border-emerald-500/20 bg-emerald-500/5 animate-pulse"></div>
              <div className="relative z-10 flex flex-col items-center">
                <span className="text-2xl font-bold text-white tracking-tighter">{currentProducts || 0}</span>
                <span className="text-[9px] text-emerald-400 font-bold uppercase tracking-widest">Activos</span>
              </div>
            </div>
            <div>
              <p className="text-sm font-medium text-white mb-1">Catálogo Ilimitado</p>
              <p className="text-xs text-slate-500">Sin límites de carga</p>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-1 glass-panel p-8 relative overflow-hidden flex flex-col justify-between group">
          ...
          <div className="relative z-10 flex justify-between items-center mb-4">
            <h3 className="text-slate-400 font-medium tracking-wide text-sm uppercase">Visitas</h3>
            <div className="p-2 bg-white/5 rounded-lg border border-white/[0.07]">
