        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="glass-panel p-4 space-y-4">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-slate-500">Primer pedido</span>
          ...
          <div className="space-y-4">
            ...
            <div className="glass-panel p-8 text-center text-slate-500 text-sm">
              ...
              <button className="mt-4 px-4 py-2 border border-white/[0.07] rounded-lg hover:bg-white/5 transition-colors text-white text-sm font-medium">
