...
import { login } from "@/actions/esencial/auth";
import { useActionState } from "react";
import { SubmitButton } from "@/components/esencial/SubmitButton";
    ...
    <div className="min-h-screen w-full flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative z-10">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="flex justify-center mb-6">
          <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-white to-zinc-400 flex items-center justify-center shadow-lg shadow-white/10">
        ...
        <p className="mt-2 text-center text-sm text-zinc-400 text-balance px-4">
          Iniciá sesión para acceder al panel de administración de tu SitioHoy.
        </p>
      </div>
