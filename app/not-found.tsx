...
export default function NotFound() {
  return (
    <div className="fixed inset-0 z-[9999] bg-transparent flex flex-col items-center justify-center p-6 overflow-hidden font-sans">
      ...
      <div className="relative z-10 text-center w-full px-4">
        ...
        <div className="space-y-6 -mt-8">
          ...
          <div className="flex items-center justify-center pt-4">
            <Link
              href="/admin"
              className="group flex items-center gap-2 bg-white text-black px-8 py-4 rounded-2xl font-bold hover:bg-slate-200 transition-all shadow-[0_20px_50px_rgba(255,255,255,0.1)] active:scale-95"
            >
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 opacity-40 hover:opacity-100 transition-all duration-700">
        ...
        <div className="flex items-center gap-3">
            <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-slate-500 whitespace-nowrap">Powered by</span>
            <Image 
