...
export function StatsCard({ title, value, icon: Icon, trend, color }: StatsCardProps) {
  return (
    <div className="glass-panel p-6 flex flex-col gap-4 group transition-all duration-300 hover:border-white/[0.07]">
      ...
      <div>
        <h3 className="text-slate-500 text-xs font-semibold uppercase tracking-widest">{title}</h3>
